...
Operators.push(new Operator('lessThan', (a, b) => Math.exp(-Math.max(0, ((a - b) / 250) + epsilon)), numberValidator))
/**
 ...
 */
Operators.push(new Operator('greaterThan', (a, b) => Math.exp(-Math.max(0, ((b - a) / 250) + epsilon)), numberValidator))
/**
