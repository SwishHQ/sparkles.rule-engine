...
describe('Engine: event', () => {
  ...
  context('rule events: json serializing', () => {
    ...
    it('serializes properties', async () => {
      ...
      const expected =
        '{"conditions":{"priority":1,"weight":1,"any":[{"name":"over 21","operator":"greaterThanInclusive","value":21,"fact":"age","factResult":21,"valueResult":21,"result":true,"score":1},{"operator":"equal","value":true,"fact":"qualified","factResult":false,"valueResult":true,"result":false,"score":0}]},"event":{"type":"setDrinkingFlag","params":{"canOrderDrinks":true}},"priority":100,"score":1,"result":true}'
  ...
  context('rule events: json serializing with condition reference', () => {
    ...
    it('serializes properties', async () => {
      ...
      const expected = '{"conditions":{"priority":1,"weight":1,"any":[{"priority":1,"weight":1,"all":[{"name":"over 21","operator":"greaterThanInclusive","value":21,"fact":"age","factResult":21,"valueResult":21,"result":true,"score":1}]}]},"event":{"type":"awesome"},"priority":100,"score":1,"result":true}'
      expect(JSON.stringify(ruleResult)).to.equal(expected)
    })
  })
  ...
  context('rule events: json serializing with condition reference that is undefined', () => {
    ...
    it('serializes properties', async () => {
      ...
      const expected = '{"conditions":{"priority":1,"weight":1,"any":[{"name":"nameOfTheUndefinedConditionReference","condition":"conditionThatIsNotDefined"},{"name":"over 21","operator":"greaterThanInclusive","value":21,"fact":"age","factResult":21,"valueResult":21,"result":true,"score":1}]},"event":{"type":"awesome"},"priority":100,"score":1,"result":true}'
      expect(JSON.stringify(ruleResult)).to.equal(expected)
    })
  })
})
